    ...
    <section class="search-section">
      <div class="search-container">
        <div class="ui-filterbar">
          <div class="ui-filterbar-primary ui-input-iconwrap">
          ...
          <div class="ui-filterbar-group">
            <input
              v-model="filters.organizer"
              type="text"
              placeholder="主办方(可选)"
              class="ui-input filter-compact"
              @keyup.enter="loadContests"
            />
            ...
            <select v-model="filters.status" @change="loadContests" class="ui-input ui-select filter-compact">
            ...
            <button @click="loadContests" class="ui-btn ui-btn-primary">
            ...
            <button @click="resetFilters" class="ui-btn ui-btn-secondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <main class="contests-main">
      <div class="contests-container">
        ...
        <div v-else-if="contests.length > 0" class="contests-grid">
          <div v-for="contest in contests" :key="contest.id" class="contest-card">
            ...
            <div class="card-footer">
              <button @click="handleRedirect(contest.id)" class="ui-btn ui-btn-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
                  <polyline points="15 3 21 3 21 9"/>
                  <line x1="10" y1="14" x2="21" y2="3"/>
                </svg>
                {{ isLoggedIn ? (userRole === 'teacher' ? '教师入口' : '参赛入口') : '登录后跳转' }}
              </button>

              <button @click="viewDetail(contest.id)" class="ui-btn ui-btn-secondary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div v-else class="empty-state">
          ...
          <button @click="resetFilters" class="ui-btn ui-btn-primary">重置筛选</button>
        </div>
      </div>
